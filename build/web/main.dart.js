...
["clock.main", "main.dart", , E, {
  "^": "",
  main: [function() {
    var canvas, t1, t2, t3, t4, t5, rect, env, distance, ball1, ball2;
    canvas = document.querySelector("#area");
    t1 = new Q.Engine(canvas, null, null, null, null, null, null);
    t2 = canvas.parentElement;
    t3 = C.JSNumber_methods.round$0(t2.clientLeft);
    t4 = C.JSNumber_methods.round$0(t2.clientTop);
    t5 = C.JSNumber_methods.round$0(t2.clientWidth);
    t2 = C.JSNumber_methods.round$0(t2.clientHeight);
    if (t5 < 0)
      t5 = -t5 * 0;
    rect = H.setRuntimeTypeInfo(new P.Rectangle(t3, t4, t5, t2 < 0 ? -t2 * 0 : t2), [null]);
    t2 = rect.width;
    t1.width = t2;
    t3 = rect.height;
    t1.height = t3;
    t4 = J.getInterceptor$x(canvas);
    t4.set$width(canvas, t2);
    t4.set$height(canvas, t3);
    t1.solarSystem = Q.SolarSystem$();
    t3 = new Q.Fall(null, "#FF0000", "#FFFFFF", "#FF66FF", null, null, null, 0);
    env = new Q.Environment(0.99, 9.81);
    distance = H.setRuntimeTypeInfo(new P.Point(4, 300), [null]);
    t3.ground = new Q.Line(H.setRuntimeTypeInfo(new P.Point(distance.x, 200), [null]), H.setRuntimeTypeInfo(new P.Point(distance.y, 200), [null]), "#FF0000", 1000);
    t4 = new Q.Ball(10, "#FF66FF", null, H.setRuntimeTypeInfo(new P.Point(100, 100), [null]), null, true, env);
    t4.mass = 10;
    t4.moving = H.setRuntimeTypeInfo(new P.Point(0, 0), [null]);
    t3.ball = t4;
    t4 = new Q.Ball(20, "#FFFFFF", null, H.setRuntimeTypeInfo(new P.Point(200, 50), [null]), null, true, env);
    t4.mass = 20;
    t4.moving = H.setRuntimeTypeInfo(new P.Point(0, 0), [null]);
    t3.ball2 = t4;
    t1.fall = t3;
    t3 = H.setRuntimeTypeInfo([], [Q.GravityObject]);
    ball1 = new Q.GBall(10, null, 300, null, H.setRuntimeTypeInfo(new P.Point(250, 500), [null]), Q.GravityEnvironment$());
    ball1.movingVector = H.setRuntimeTypeInfo(new P.Point(0, 0), [null]);
    ball1.color = "#fff";
    ball1.color = "green";
    ball2 = new Q.GBall(10, null, 500000, null, H.setRuntimeTypeInfo(new P.Point(350, 500), [null]), Q.GravityEnvironment$());
    ball2.movingVector = H.setRuntimeTypeInfo(new P.Point(0, 0), [null]);
    ball2.color = "#fff";
    ball2.color = "red";
    ball2.movingVector = H.setRuntimeTypeInfo(new P.Point(-0.5, -0.5), [null]);
    t3.push(ball1);
    t3.push(ball2);
    t1.gravity = new Q.Gravity(null, t3);
    t3 = window;
    t1 = t1.get$draw();
    C.Window_methods._ensureRequestAnimationFrame$0(t3);
    C.Window_methods._requestAnimationFrame$1(t3, W._wrapZone(t1));
...
["solar", "package:solar/solar.dart", , Q, {
  "^": "",
  SolarSystem: {
    "^": "Object;sun,earth,moon,drawables",
    draw$3: function(context, p, renderTime) {
      var t1, iter;
      for (t1 = this.drawables, iter = new J.ArrayIterator(t1, t1.length, 0, null); iter.moveNext$0();)
        iter.__interceptors$_current.draw$3(context, p, renderTime);
    },
    SolarSystem$0: function() {
      var t1, t2, i, period, t3;
      t1 = new Q.SpaceObject(30, 0, 0, null, H.setRuntimeTypeInfo([], [Q.SpaceObject]), "#fff");
      t1.orbitSpeed = t1.calculateSpeed$1(0);
      this.sun = t1;
      t1.color = "#FFFF00";
      t1 = new Q.SpaceObject(10, 200, 2, null, H.setRuntimeTypeInfo([], [Q.SpaceObject]), "#fff");
      t1.orbitSpeed = t1.calculateSpeed$1(2);
      this.earth = t1;
      t1.color = "#0000CC";
      t1 = new Q.SpaceObject(2, 20, 0.05, null, H.setRuntimeTypeInfo([], [Q.SpaceObject]), "#fff");
      t1.orbitSpeed = t1.calculateSpeed$1(0.05);
      this.moon = t1;
      t1.color = "#C0C0C0";
      this.earth.orbiters.push(t1);
      this.sun.orbiters.push(this.earth);
      t1 = this.sun.orbiters;
      t2 = new Q.SpaceObject(10, 100, 0.3, null, H.setRuntimeTypeInfo([], [Q.SpaceObject]), "#fff");
      t2.orbitSpeed = t2.calculateSpeed$1(0.3);
      t1.push(t2);
      for (i = 0; i < 500; ++i) {
        t1 = C.C__JSRandom.nextDouble$0();
        period = 4.5 + C.C__JSRandom.nextDouble$0() * 3.5;
        C.C__JSRandom.nextDouble$0();
        t2 = this.sun.orbiters;
        t3 = [];
        t3.$builtinTypeInfo = [Q.SpaceObject];
        t1 = new Q.SpaceObject(1, 280 + t1 * 110, period, null, t3, "#fff");
        t1.orbitSpeed = period === 0 ? 0 : 1 / (2880 * period);
        t2.push(t1);
      }
      this.drawables.push(this.sun);
    },
    static: {SolarSystem$: function() {
        var t1 = new Q.SolarSystem(null, null, null, H.setRuntimeTypeInfo([], [Q.SpaceObject]));
        t1.SolarSystem$0();
        return t1;
      }}
  },
  SpaceObject: {
    "^": "Object;bodySize,orbitRadius,orbitPeriod,orbitSpeed,orbiters,color",
    calculateSpeed$1: function(period) {
      return period === 0 ? 0 : 1 / (2880 * period);
    },
    calculatePos$2: function(renderTime, p) {
      var t1, angle, t2, t3, t4, t5;
      t1 = this.orbitSpeed;
      if (t1 === 0)
        return p;
      if (typeof renderTime !== "number")
        return renderTime.$mul();
      if (typeof t1 !== "number")
        return H.iae(t1);
      angle = renderTime * t1;
      t1 = this.orbitRadius;
      t2 = Math.cos(H.checkNum(angle));
      t3 = p.x;
      if (typeof t3 !== "number")
        return H.iae(t3);
      t4 = Math.sin(H.checkNum(angle));
      t5 = p.y;
      if (typeof t5 !== "number")
        return H.iae(t5);
      return H.setRuntimeTypeInfo(new P.Point(t1 * t2 + t3, t1 * t4 + t5), [null]);
    },
    draw$3: function(context, p, renderTime) {
      var pos = this.calculatePos$2(renderTime, p);
      this.drawSelf$2(context, pos);
      this.drawOrbiters$3(context, pos, renderTime);
    },
    drawSelf$2: function(context, p) {
      ...
      context.beginPath();
      context.arc(t1, t3, t2, 0, 6.283185307179586, false);
    ...
    drawOrbiters$3: function(context, p, renderTime) {
      var t1, iter;
      for (t1 = this.orbiters, iter = new J.ArrayIterator(t1, t1.length, 0, null); iter.moveNext$0();)
        iter.__interceptors$_current.draw$3(context, p, renderTime);
    }
  },
  Line: {
    "^": "Object;start,end,color,mass"
  },
  Ball: {
    "^": "Object;radius,color,mass,position,moving,movingDirectionIntoGravity,env",
    calcMoving$1: function(dTime) {
      var t1, dPoint, t2, t3;
      t1 = this.env;
      dPoint = H.setRuntimeTypeInfo(new P.Point(0, dTime / 1000 * t1.fallPerSec), [null]);
      t2 = this.position.y;
      if (typeof t2 !== "number")
        return t2.$gt();
      if (t2 > 200 - this.radius - 4)
        this.movingDirectionIntoGravity = !this.movingDirectionIntoGravity;
      else {
        t2 = this.movingDirectionIntoGravity;
        t3 = this.moving;
        if (t2)
          this.moving = t3.$add(0, dPoint);
        else
          this.moving = t3.$sub(0, dPoint);
      }
      t2 = this.moving;
      t3 = t2.x;
      t1 = t1.airRubbingLoss;
      if (typeof t3 !== "number")
        return t3.$mul();
      t2 = t2.y;
      if (typeof t2 !== "number")
        return t2.$mul();
      t1 = H.setRuntimeTypeInfo(new P.Point(t3 * t1, t2 * t1), [null]);
      this.moving = t1;
      t2 = this.movingDirectionIntoGravity;
      t3 = this.position;
      if (t2)
        this.position = t3.$add(0, t1);
      else
        this.position = t3.$sub(0, t1);
    },
    draw$2: function(context, renderTime) {
      var t1;
      context.lineWidth = 0.5;
      t1 = this.color;
      ...
      context.beginPath();
      t1 = this.position;
      context.arc(t1.x, t1.y, this.radius, 0, 6.283185307179586, false);
      context.fill("nonzero");
      context.closePath();
      context.stroke();
    }
  ...
  Environment: {
    "^": "Object;airRubbingLoss,fallPerSec"
  },
  Fall: {
    "^": "Object;env,colorRed,colorWhite,colorPink,ground,ball,ball2,oldRenderTime"
  },
  GravityEnvironment: {
    "^": "Object;airFriction,velocityOfFall,gravity",
    GravityEnvironment$0: function() {
      this.airFriction = 0.01;
      this.velocityOfFall = 9.81;
      H.checkNum(10);
      H.checkNum(-11);
      this.gravity = 6.673 * Math.pow(10, -11);
    },
    static: {GravityEnvironment$: function() {
        var t1 = new Q.GravityEnvironment(null, null, null);
        t1.GravityEnvironment$0();
        return t1;
      }}
  },
  RenderableObject: {
    "^": "Object;",
    prepareDraw$0: function() {
    },
    draw$2: function(context, renderTime) {
    }
  },
  GravityObject: {
    ...
    distanceToPoint$1: function(to) {
      ...
      H.checkNum(t3);
      H.checkNum(2);
      return Math.sqrt(H.checkNum(t2 + Math.pow(t3, 2)));
    },
    getAttractionTo$1: function(object) {
      var disantance, t1, t2, t3;
      disantance = this.distanceToPoint$1(object.position);
      t1 = this.enviroment.gravity;
      t2 = this.mass;
      t3 = object.mass;
      H.checkNum(disantance);
      H.checkNum(2);
      return t1 * (t2 * t3 / Math.pow(disantance, 2));
    }
  },
  GBall: {
    "^": "GravityObject;radius,color,mass,movingVector,position,enviroment",
    prepareDraw$0: function() {
      this.position = this.position.$add(0, this.movingVector);
    },
    draw$2: function(context, renderTime) {
      var t1;
      context.lineWidth = 0.5;
  ...
  Gravity: {
    "^": "Object;ball,gravitons",
    draw$2: function(context, renderTime) {
      var t1, t2, ball1, ball2, attractionB12B2, attractionB22B1, t3, t4, t5, t6;
      t1 = this.gravitons;
      t2 = t1.length;
      if (0 >= t2)
        return H.ioore(t1, 0);
      ...
      if (1 >= t2)
        return H.ioore(t1, 1);
      ball2 = t1[1];
      ball1.distanceToPoint$1(ball2.position);
      attractionB12B2 = ball1.getAttractionTo$1(ball2);
      attractionB22B1 = ball2.getAttractionTo$1(ball1);
      t2 = ball2.position;
      t3 = t2.x;
      t4 = ball1.position;
      t5 = t4.x;
      ...
      if (typeof t4 !== "number")
        return H.iae(t4);
      ball2.movingVector = H.setRuntimeTypeInfo(new P.Point((t3 - t5) * attractionB22B1, (t2 - t4) * attractionB22B1), [null]);
      t4 = ball1.movingVector;
      t2 = t4.x;
      t5 = ball1.position;
      t3 = t5.x;
      t6 = ball2.position.y;
      ...
      if (typeof t4 !== "number")
        return t4.$sub();
      ball1.movingVector = H.setRuntimeTypeInfo(new P.Point(t2 - (t3 - t6) * attractionB12B2, t4 - (t5 - t6) * attractionB12B2), [null]);
      P.print(ball2.movingVector);
      C.JSArray_methods.forEach$1(t1, new Q.Gravity_draw_closure(context, renderTime));
    }
  },
  Gravity_draw_closure: {
    "^": "Closure:9;_captured_context_0,_captured_renderTime_1",
    call$1: function(object) {
      object.prepareDraw$0();
      object.draw$2(this._captured_context_0, this._captured_renderTime_1);
    }
  },
  Engine: {
    "^": "Object;canvas,renderTime,width,height,solarSystem,fall,gravity",
    draw$1: [function(_) {
      var t1, t2, t3, context, dTime, t4, t5, t6;
      t1 = Date.now();
      t2 = this.renderTime;
      if (t2 != null) {
        if (typeof t2 !== "number")
        ...
        t3 = t2 * 0.05 + t3 * 0.95;
        $._fpsAverage = t3;
        $.get$_notes().textContent = "" + C.JSDouble_methods.round$0(t3) + " fps";
      }
      this.renderTime = t1;
      ...
      if (typeof t3 !== "number")
        return t3.$div();
      t1.draw$3(context, H.setRuntimeTypeInfo(new P.Point(t2 / 2, t3 / 2), [null]), this.renderTime);
      t3 = this.fall;
      t2 = this.renderTime;
      t1 = t3.oldRenderTime;
      if (typeof t1 !== "number")
      ...
      if (t1 > 0) {
        ...
        dTime = t2 - t1;
        t1 = t3.ball.position;
        t4 = H.setRuntimeTypeInfo(new P.Point(100, 200), [null]);
        t5 = t4.x;
        t6 = t1.x;
        if (typeof t5 !== "number")
          return t5.$sub();
        ...
        H.checkNum(t1);
        H.checkNum(2);
        Math.sqrt(H.checkNum(t6 + Math.pow(t1, 2)));
        t3.ball.calcMoving$1(dTime);
        t3.ball2.calcMoving$1(dTime);
        t1 = t3.ground;
        context.lineWidth = 4;
        t6 = t1.color;
        context.fillStyle = t6;
        context.strokeStyle = t6;
        context.beginPath();
        t6 = t1.start;
        context.moveTo(t6.x, t6.y);
        t1 = t1.end;
        context.lineTo(t1.x, t1.y);
        context.stroke();
        context.closePath();
        t3.ball.draw$2(context, t2);
        t3.ball2.draw$2(context, t2);
      }
      t3.oldRenderTime = t2;
      this.gravity.draw$2(context, this.renderTime);
      t1 = window;
      t2 = this.get$draw();
    ...
    }, "draw$0", "call$1", "call$0", "get$draw", 0, 2, 10, 0]
  }
}],
...
(function(lazies) {
  ...
  return [];
}, "_toStringVisiting", "_notes", "get$_notes", function() {
